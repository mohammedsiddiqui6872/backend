...
async function testWaiterLoads() {
  try {
    ...
    console.log('\nTesting waiter loads endpoint...');
    const waiterLoadsResponse = await axios.get('http://localhost:5000/api/admin/staff-assignments/waiter-loads', {
      headers: {
